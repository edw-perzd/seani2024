...
class Question(models.Model):
    ...
    question_text = models.CharField(verbose_name = 'Texto de la pregunta', max_length = 200, null = True, blank = True)
    question_image = models.ImageField(verbose_name='Imagen de la pregunta', upload_to='questions', null = True, blank = True)
